...
| Registered Status | 8(a) Program Participant; Service Disabled Veteran Owned Business; Woman Owned Small Business; Economically Disadvantaged Women Owned Small Business; Black American Owned Business; LLC; UEI JSRCFJVJM874 |
| CAGE Code | 72UJ9 |
...
### Arlo's own description of the OUSD(I&S) Enterprise BPA HQ003425A0004 task areas — "specialized and sensitive Technical, Administrative, and Professional Services" across ten enumerated task categories. Arlo's page heading for this contract is "VA T4NG2" but the description body and the contract number HQ003425A0004 confirm it is the OUSD(I&S) Enterprise BPA, not a VA contract. T4NG2 is a real, separate VA IT vehicle (Transformation Twenty-One Total Technology Next Generation 2 — 30 prime awardees announced October 2023). Arlo is NOT a T4NG2 prime — USAspending shows zero VA contracts under Arlo's UEI JSRCFJVJM874, and Arlo does not appear in the published T4NG2 awardee list. The heading-vs-body mismatch on Arlo's page is most likely a CMS template-reuse error — Arlo's server retains a 2024-10-uploaded VA-T4NG2 logo asset (per Wayback capture), suggesting Arlo had earlier T4NG2 marketing intent (subcontractor positioning or aspirational bid material) before re-purposing the page entry for the OUSD(I&S) BPA win in February 2025.
...
### Arlo's own recruitment page advertises Influence, Deception, and Perception Management Activities Staff Officer SME IV and V positions (verbatim mission language paralleling the IPMO charter). The role description names OUSW(I&S) / OUSD(I&S) generally as the customer; no IPMO-direct contract is named on the recruitment page or elsewhere in Arlo's primary-source record.
...
| HQ003425A0004 | WHS | 2025-02-14 | $856,000,000 good faith estimate amount for all BPAs (aggregate across four BPA vendors: Arlo, Sancorp, Premier, and Comprehensive Approach), not Arlo's individual ceiling. USAspending records this $856,000,000 in the parent BPA base_and_all_options field; per the GAO B-422985 decision the figure is the aggregate good faith estimate for all BPAs awarded under HQ003424R0178. | [`/organizations/ousd-is`] | OUSD(I&S) Enterprise BPA — Technical, Administrative and Professional Support Services | government/usaspending-arlo-bpa-hq003425a0004.json |
| HQ003425F0104 | WHS (BPA Call Order under HQ003425A0004) | 2025-02-21 – 2026-03-27 | $78,512,350.27 base-and-all-options per USAspending; $7,447,926.22 base exercised options per USAspending; "more than $85 million" per Arlo's March 16, 2026 SASP press statement. The ~$6.5 million gap between Arlo's announcement and the USAspending record is unreconciled in source. | [`/organizations/ousd-is`] | SASP Call Order 2 — Administrative, Policy, Operations, and Analytic Support Services to the OUSD(I&S) Sensitive Activities & Special Programs Office | government/usaspending-arlo-hq003425f0104.json |
...
| 2025-02-14 | WHS established BPA HQ003425A0004 (Technical, Administrative, and Professional Support Services to the OUSD(I&S) Enterprise) with Arlo as one of four BPA vendors following the reevaluation under HQ003424R0178; $856 million good faith estimate amount applies across all four BPAs aggregate, not Arlo's individual ceiling. | contract | government/usaspending-arlo-bpa-hq003425a0004.json |  |
