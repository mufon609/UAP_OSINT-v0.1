...
| Field | Value |
|---|---|
| Type | Independent nonprofit R&D institute |
| Founded | 1946 |
...
| [`/people/suresh-sunderrajan`] | Chief Financial Officer (from 2024-01-19; previously President, Commercialization) | 2024-01-19 | news/propublica-sri-international-941160950-20260515.html | Suresh Sunderrajan is named in the ProPublica Compensation, Key Employees and Officers section for the fiscal year ending Dec. 2024 with the listing "Chief Financial Officer From 1/19/24" — the source listing for Sunderrajan's 2024-01-19 CFO start date. The same source lists Sunderrajan in the section for fiscal year ending Dec. 2023 as "President, Commercialization" — the prior role recorded before the transition to CFO. |
...
### CIA primary-source attestation that the SRI parapsychology investigation had drawn sufficient attention from the Soviet intelligence community by November 1976 to prompt DCI George Bush to request a briefing on CIA's parapsychology investigations. Anchors a lower-bound for the SRI program's active period (continued at least through Nov 1976).
...
### DIA institutional attestation of the 1975 CIA-funding-discontinuation date for the SRI parapsychology investigation, and of the post-1975 funding chain — "DIA and some of DIA's service support elements with occasional support from various R&D organizations" (the service support elements include the Air Force Foreign Technology Division and Army INSCOM, per Section III's later detail attesting "HQDA/INSCOM established a small unit" late 1970s, transferred to DIA 1986 as the SUN STREAK SAP).

> Then funding was discontinued in 1975; subsequent funding for RV investigation at SRI was provided by DIA and some of DIA's service support elements
...
### Independent government-commissioned AIR evaluation (prepared at CIA's request at the end of the Stargate Project) describes the 1974-1975 SRI controlled experiments and cites Puthoff and Targ (1975) "Perceptual Augmentation Techniques: Part Two—Research Report, Stanford Research Institute Final Report, Dec. 1, 1975" — the foundational SRI internal report from the parapsychology investigation.
...
### AIR review of the 1988 SRI internal program analysis (May, Utts, Trask, Luke, Frivold, Humphrey 1988 "Review of the psychoenergetic research conducted at SRI International (1973-1988)") establishes the institutional shape of the SRI parapsychology program over its 1973-1988 documented span: 154 experiments, over 26,000 individual trials, 227 total subjects. Direction of Dr. Edwin May from mid-1970s per AIR Section 3 preamble.
...
| Field | Value |
|---|---|
| Attributed to | SRI International 'About' page (sri.com/about/), retrieved 2026-05-15 — institutional tagline |
| Source | [archived source](../sources/news/sri-international-about-20260515.html) |
| Location | ¶1 |

---

### Foundational SRI self-attestation establishing the four institutional milestones: 1946 founding (as Stanford Research Institute), 1970 independence, 1987 Sarnoff Corp. acquisition, 2023 PARC acquisition. Also attests current scale (1,500 researchers and professional staff) and customer base (government and commercial).
...
| Field | Value |
|---|---|
| Attributed to | SRI International 'About' page (sri.com/about/), retrieved 2026-05-15 — institutional anchor paragraph |
| Source | [archived source](../sources/news/sri-international-about-20260515.html) |
| Location | ¶4 |
...
| Field | Value |
|---|---|
| Attributed to | SRI International 'Interactive Timeline of Innovation' page (sri.com/timeline-of-innovation/), retrieved 2026-05-15 — anchor paragraph |
...
| Field | Value |
|---|---|
| Attributed to | Russell Targ's ESP Research website (espresearch.com homepage), retrieved 2026-05-07 — Targ self-attestation |
...
| 1973 | Pat Price [`/people/pat-price`] arrives at SRI in early-to-mid 1973 per Kress 1977 narrative ordering (specific arrival date not attested) as the third sensitive subject; "the remote viewing experiments... began in earnest". Per Targ IRVA 2002, Price was a "retired police commissioner". | program-inception | government/cia-kress-parapsychology-in-intelligence-studies-intelligence-1977-declassified-1996.pdf |  |
...
- [`/documents/air-mumford-evaluation-remote-viewing-1995`]
- [`/documents/dia-stargate-project-overview-1993`]
- [`/documents/kress-parapsychology-in-intelligence-1977`]
- [`/documents/nature-1974-targ-puthoff-information-transmission`]
- [`/documents/sri-perceptual-augmentation-techniques-final-report-1975`]
