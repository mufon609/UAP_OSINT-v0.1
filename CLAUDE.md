...
|---|---|---|
| `/people/__smoke-person-eyewitness` | active | eyewitness |
| `/people/__smoke-person-iact` | active | institutional-actor |
| `/people/__smoke-person-reporter` | active | reporter |
| `/people/__smoke-person-whistleblower` | active | whistleblower |
...
| Node | Status | Kind |
|---|---|---|
| `/organizations/__smoke-org-contractor` | active | gov-contractor |
| `/organizations/__smoke-org-gov` | active | gov |
| `/organizations/__smoke-org-private` | active | private |
...
| `/events/__smoke-event-encounter` | documented | encounter |
| `/events/__smoke-event-hearing` | documented | hearing |

### Documents (13)

| Node | Status | Kind |
|---|---|---|
| `/documents/__smoke-doc-book` | primary-source-confirmed | non-gov-doc |
| `/documents/__smoke-doc-gov` | primary-source-confirmed | gov-doc |
| `/documents/__smoke-doc-non-gov` | primary-source-confirmed | non-gov-doc |
| `/documents/__smoke-doc-social` | primary-source-confirmed | non-gov-doc |
...
| `/transcripts/__smoke-trans-hearing` | primary-source-confirmed | hearing |
| `/transcripts/__smoke-trans-other` | primary-source-confirmed | other |
...
| Node | Status | Kind |
|---|---|---|
| `/media/__smoke-media-audio` | primary-source-confirmed | audio |
| `/media/__smoke-media-deriv` | primary-source-confirmed | video |
| `/media/__smoke-media-imagery` | primary-source-confirmed | imagery-other |
| `/media/__smoke-media-photo` | primary-source-confirmed | photo |
| `/media/__smoke-media-video` | primary-source-confirmed | video |
| `/media/flir1-video` | primary-source-confirmed | video |

### Locations (2)

- `/locations/__smoke-location` — active
- `/locations/skinwalker-ranch` — active

### Findings (5)

- `/findings/__smoke-finding` — in-progress
...
- `/investigations/__smoke-investigation` — open
