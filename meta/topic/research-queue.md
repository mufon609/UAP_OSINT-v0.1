...
| `/documents/air-mumford-evaluation-remote-viewing-1995` | document / gov-doc | High | The September 29, 1995 American Institutes for Research evaluation of the CIA STARGATE remote viewing program — the load-bearing document for the STARGATE-termination discourse. 1,325 paragraphs total; currently cited piecemeal from `/people/hal-puthoff`, `/people/russell-targ`, and `/organizations/stanford-research-institute` (~17% combined coverage per 2026-05-19 source-coverage audit). Document node would consolidate the panel methodology (Utts + Hyman selection), Section 3 SRI-program history preamble, the laboratory experiments review, the operational-utility findings, and the program-termination recommendation. Already archived in manifest; already in broken-link registry (1 ref from `/organizations/stanford-research-institute`). | Archived `government/air-mumford-evaluation-remote-viewing-stargate-19950929.pdf` |
| `/people/jessica-utts` | person / institutional-actor | Medium | Statistics professor at UC Davis; one of the two AIR 1995 evaluation panel members. Her published assessment ("the statistical results of the studies examined are far beyond what is expected by chance ... arguments that these results could be due to methodological flaws in the experiments are soundly refuted") concluded evidence supports continued research — the load-bearing dissent vs. Hyman within the AIR evaluation. Currently appears 109× unreferenced in the Mumford 1995 source per 2026-05-19 coverage audit; referenced in `/people/russell-targ` + `/organizations/stanford-research-institute` only as a 1988 SRI internal-study co-author, NOT as the AIR panel member. Building this node closes the STARGATE-termination dissent gap. | Public record (UC Davis bio + published Utts 1995 evaluation paper) |
| `/people/raymond-hyman` | person / institutional-actor | Medium | Psychology professor at University of Oregon; the other AIR 1995 evaluation panel member; longtime methodological skeptic of parapsychology. His evaluation reached the opposite conclusion from Utts — that the SRI/SAIC data could be explained by methodological flaws — the split with Utts is *the* load-bearing finding of the STARGATE-termination discourse. Currently absent from every artifact in the corpus despite multiple appearances in the Mumford 1995 source. | Public record (U of Oregon bio + published Hyman 1995 evaluation paper) |
...
| `/events/2022-05-17-hpsci-uap-hearing` | event / hearing | High | The May 17, 2022 House Permanent Select Committee on Intelligence Subcommittee on Counterterrorism, Counterintelligence, and Counterproliferation UAP hearing — the first public congressional UAP hearing in over 50 years, where DepUSDI&S Ronald Moultrie ([`/people/ronald-moultrie`]) and Deputy Director of Naval Intelligence Scott Bray testified on the just-stood-up UAP Task Force ([`/organizations/uaptf`]) → AARO transition. The 1,155-paragraph stenographic transcript is currently cited only from `/organizations/uaptf` (~40% coverage per 2026-05-19 audit) and lacks dedicated event + transcript nodes. The Bray "no material recovered" testimony on the open-session record is load-bearing for the Grusch / Shellenberger non-disclosure findings. | Archived `government/congress-gov-hpsci-uap-transcript-20220517.pdf` |
| `/transcripts/2022-05-17-hpsci-bray` | transcript / hearing | High | Scott Bray's portion of the 2022-05-17 HPSCI hearing — would carry the verbatim "no material we have recovered" testimony that subsequent Grusch-disclosure framing rests against. Companion to the event node above. | Archived (same stenographic PDF) |
| `/transcripts/2022-05-17-hpsci-moultrie` | transcript / hearing | High | Ronald Moultrie's portion of the 2022-05-17 HPSCI hearing — the OUSD(I&S) testimony on AARO establishment and oversight structure. Moultrie's [`/people/ronald-moultrie`] person node is built; the transcript node would carry his verbatim sworn statements. Companion to the event node above. | Archived (same stenographic PDF) |
| `/documents/blackvault-sancorp-23-f-1114-aaro-pws` | document / gov-doc | Medium | FOIA-released AARO Performance Work Statement (FOIA 23-F-1114, BlackVault release) — the contract-scope document defining AARO's operational requirements, deliverables, and contractor (Sancorp Consulting) tasking. 917-paragraph document currently cited piecemeal from `/organizations/aaro`, `/organizations/ousd-is`, `/organizations/sancorp-consulting`, and `/people/sean-kirkpatrick` (~25% combined coverage per 2026-05-19 audit). Document node would consolidate the operational-scope definition that the contractor-side narrative rests on. | Archived `government/blackvault-sancorp-23-f-1114-aaro-pws.pdf` |
| `/documents/written-testimony-shellenberger-2024` | document / gov-doc | Medium | Michael Shellenberger's written testimony for the November 13, 2024 House Oversight subcommittee UAP hearing — 1,052 paragraphs covering his "Immaculate Constellation" report, the claimed UAP-whistleblower his investigation surfaced, and the DOD/IC non-disclosure framing. Currently cited only from `/organizations/aaro` and `/locations/skinwalker-ranch` (~3% combined coverage per 2026-05-19 audit). Note: companion event node for the 2024-11-13 hearing also unbuilt — building this document is the first step toward closing that hearing's coverage ring. | Archived `government/oversight-house-gov-shellenberger-written-testimony-20241113.pdf` |
...
on their rationale cells; not duplicated here.
