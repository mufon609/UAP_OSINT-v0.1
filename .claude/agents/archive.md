...
tools: Read, Bash(python3 scripts/tools/manifest.py *), Bash(python3 scripts/tools/archive.py *), Bash(python3 scripts/build/extract-source.py *), Bash(curl *), WebFetch
