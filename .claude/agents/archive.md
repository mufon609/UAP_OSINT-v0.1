...
tools: Read, Bash(python3 scripts/tools/manifest.py *), Bash(python3 scripts/tools/archive.py *), Bash(python3 scripts/tools/browser-fetch.py *), Bash(python3 scripts/build/extract-source.py *), Bash(python3 scripts/build/validate.py *), Bash(curl *), WebFetch
