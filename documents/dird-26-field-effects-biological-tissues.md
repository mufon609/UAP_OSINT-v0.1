...
# Anomalous Acute and Subacute Field Effects on Human Biological Tissues — DIA Defense Intelligence Reference Document, AAWSAP, 11 March 2010
...
| Format | PDF, 39 pages |
| Primary Source URL | https://documents2.theblackvault.com/documents/dia/AAWSAP-DIRDs/DIRD_26-DIRD_Anomalous_Acute_and_Subacute_Field_Effects_on_Human_Biological_Tissues.pdf |
...
Anomalous Acute and Subacute Field Effects on Human Biological Tissues. The Defense Intelligence Reference Document is 11 March 2010, with an ICOD of 1 December 2009; UNCLASSIFIED//FOR OFFICIAL USE ONLY is struck through with a black strike line on every page, and the cover shows the Defense Intelligence Reference Document banner and the Acquisition Threat Support series. On the page where the Prepared by and Author appear, the document shows [box: (b)(3):10 USC 424] and Defense Intelligence Agency, and the Author line shows [box: (b)(6) — author name redacted], so no author name appears on the document. An Administrative Note states the product is one in a series of advanced technology reports produced in FY 2009 under the Defense Intelligence Agency ([`/organizations/dia`]), [(b)(3):10 USC 424] Advanced Aerospace Weapon System Applications (AAWSA) Program [`/organizations/aawsap`], and that comments or questions should be addressed to the AAWSA Program Manager. The document is one of a series of FY 2009 AAWSA Program advanced technology reports ([`/documents/dia-aatip-products-list-2018`]); the author ([`/people/kit-green`]) appears there, not on the document, whose author line is redacted.

The Preface states that three previous fit and active individuals experienced an anomalous aerospace-related event and within 72 hours suffered medical signs and symptoms — almost immediate erythema over exposed skin, fever, pain, headaches, numbness and parasthesiae, cardiac palpitations, photophobia, and in one case moderate blood dyscrasia and signs of radiation illness; the three were antennae engineers subjected to an accidental exposure in the near-field to a broad-band ultrahigh radiofrequency mixed radiation of RF, NIEMR, and microwave energies centered at about 785 MHz. An extensive review of the medical literature revealed an additional 42 cases from the peer-reviewed literature and an additional un-published similar 300 cases of mixed exposures of from 1 –10 GHz at power densities of above 100 mW/cm². The Summary states the paper relates, summarizes, and analyzes evidence of unintended injury to human observers by anomalous advanced aerospace systems, and that the work can inform — e.g., reverse engineer — through clinical diagnoses certain physical characteristics of possible future advanced aerospace systems from unknown provenance. Sufficient incidents and medical data support a hypothesis that some advanced systems are already deployed, and opaque to full US understanding, and the medical analyses indicate the use of (to us) unconventional and advanced energy systems.

The most important bandwidth of interest is from about 300 kHz to 300 GHz, and the document describes the biophysics of how damage occurs: the term radiofrequency covers 100 kHz-300 GHz and the term microwave 300 MHz-300 GHz; tissues such as blood, skin, brain, and peripheral nerves will absorb much more energy than fat and bone; the threshold of heat perception is near 0.7 mW/cm², with power densities of about 9.0 mW/cm² causing sensations of pain within one second. The use of very high intensity RF pulses at 915 MHz will cause an elevation in brain temperature of 8 °C, resulting in petit mal or grand mal seizures and unconsciousness; the threshold for this stun effect is 680 J, and no adverse effects have been found at SARs in the head of 0.2 up to 1.0 W/kg. In the cases this reviewer has studied, the injury severity and patterns are highly consistent between the three antenna engineers and the Cash-Landrum cases. The paper describes a recent (1998), classified (until 2006) and controlled document, "Bioeffects of Selected Nonlethal Weapons," from a unit in the Intelligence and Security Command [`/organizations/inscom`], the US Army Analytical Element, whose examples of real and potential systems include near-field RF, EM, NIEMR, thermal, infrasonic, and coherent light-laser effects. The purpose of the paper is to argue that data exists to reverse engineer propulsion systems of anomalous aerospace vehicles, independent of origin, based on biology. Appendix A presents the Schuessler catalog, UFO-Related Human Physiological Effects, a compilation by MUFON's past Director, John F. Schuessler, a summary of 356 selected cases of UFO-induced physiological effects on humans during close encounters over the time period 1873 – 1994.

---

## Key Passages

### Document title — verbatim; the AAWSAP products list carries the shorter form "Field Effects on Biological Tissues"
...
### Date and ICOD — the document is dated 11 March 2010 with an information cut-off date of 1 December 2009

> 11 March 2010 ICOD: 1 December 2009

| Field | Value |
|---|---|
| Attributed to | DIRD #26 (Anomalous Acute and Subacute Field Effects on Human Biological Tissues), 11 March 2010 |
| Source | [archived source](../sources/government/dird-26-field-effects-human-biological-tissues-2010.pdf) |
| Location | p. i, ¶ date block |
...
> Prepared by:
>
> [box: (b)(3):10 USC 424] [remainder of box redacted] Defense Intelligence Agency
>
> Author:
>
> [box: (b)(6) — author name redacted]
...
### Preface anchor case — three previously fit and active individuals experienced an anomalous aerospace-related event and within 72 hours suffered acute and subacute medical signs and symptoms
...
| Attributed to | DIRD #26 (Anomalous Acute and Subacute Field Effects on Human Biological Tissues), 11 March 2010 |
| Source | [archived source](../sources/government/dird-26-field-effects-human-biological-tissues-2010.pdf) |
| Location | p. v, ¶ PREFACE |

---

### Exposure characterization — the three were subjected to a near-field accidental exposure to a broad-band ultrahigh radiofrequency mixed radiation of RF, NIEMR, and microwave energies centered at about 785 MHz
...
### Case base — a medical-literature review added 42 peer-reviewed cases and an additional un-published 300 cases of mixed exposures of 1–10 GHz at power densities above 100 mW/cm²
...
### Summary thesis — the work can inform (e.g., reverse engineer), through clinical diagnoses, physical characteristics of possible future advanced aerospace systems from unknown provenance
...
| Attributed to | DIRD #26 (Anomalous Acute and Subacute Field Effects on Human Biological Tissues), 11 March 2010 |
| Source | [archived source](../sources/government/dird-26-field-effects-human-biological-tissues-2010.pdf) |
| Location | p. v, ¶ SUMMARY |

---

### Deployment hypothesis — incidents and medical data support a hypothesis that some advanced systems are already deployed and opaque to full US understanding

> Sufficient incidents/accidents have been accurately reported, and medical data acquired, as to support a hypothesis that some advanced systems are already deployed, and opaque to full US understanding.

| Field | Value |
|---|---|
| Attributed to | DIRD #26 (Anomalous Acute and Subacute Field Effects on Human Biological Tissues), 11 March 2010 |
| Source | [archived source](../sources/government/dird-26-field-effects-human-biological-tissues-2010.pdf) |
| Location | p. vi, ¶ Summary bullet |

---

### Concluding summary claim — the medical analyses indicate the use of (to us) unconventional and advanced energy systems, without requiring an alternative biophysics
...
| Attributed to | DIRD #26 (Anomalous Acute and Subacute Field Effects on Human Biological Tissues), 11 March 2010 |
| Source | [archived source](../sources/government/dird-26-field-effects-human-biological-tissues-2010.pdf) |
| Location | p. vii, ¶ Summary final bullet |

---

### Scope of study — the most important bandwidth of interest, for tissue effects on humans, is from about 300 kHz to 300 GHz

> The most important bandwidth of interest is the range with tissue effects on humans: from about 300 kHz to 300 GHz; that is, from about 1 km to 1 mm wave lengths.
...
### Injury mechanism — very high intensity RF pulses at 915 MHz raise brain temperature 8 °C, causing petit mal or grand mal seizures and 5 minutes of unconsciousness

> The use of very high intensity RF pulses at, for example, 915 MHz will cause an elevation in brain temperature of 8 °C, resulting in petit mal or grand mal seizures after one minute exposure, followed by 5 minutes of unconsciousness.
...
### Stun-effect threshold — the stun-effect threshold is 680 J; no adverse effects have been found at head SARs of 0.2–1.0 W/kg ("Specific Absorbed Rate" and "16mJ/kg" are the document's forms)

> The threshold for this stun effect is 680 J, regardless of peak power, pulse width, and equates to about 28 kJ in terms of expressed peak absorption. This adverse effect is about 1,000 times higher than the auditory threshold, and in humans is near 16mJ/kg as reported above. No adverse effects, in any event have been found at SARs (Specific Absorbed Rate is a measure of the rate at which energy is absorbed by the body when exposed to radio-frequency electromagnetic field. It is defined as the power absorbed per mass of tissue and has units of watts per kilogram) in the head of 0.2 W/kg (950 MHz) up to 1.0 W/kg (936 & 90 MHz) [13,14].
...
### Terminology — radiofrequency covers 100 kHz–300 GHz and microwave covers 300 MHz–300 GHz of the electromagnetic spectrum

> The term radiofrequency when applied to the electromagnetic spectrum covers the frequency range 100 kHz-300 GHz; the term microwave is applied to the frequency range 300 MHz-300 GHz.

| Field | Value |
|---|---|
| Attributed to | DIRD #26 (Anomalous Acute and Subacute Field Effects on Human Biological Tissues), 11 March 2010 |
| Source | [archived source](../sources/government/dird-26-field-effects-human-biological-tissues-2010.pdf) |
| Location | p. 8, ¶ Ch. Three |

---

### Absorption physics — blood, skin, brain, and peripheral nerves absorb much more radiofrequency energy than fat and bone

> Tissues such as blood, skin, brain, and peripheral nerves will absorb much more energy than fat and bone.
...
### Heat-perception thresholds — heat perception near 0.7 mW/cm² and pain at about 9.0 mW/cm² within one second ("non-liner" is the document's form for non-linear)

> The threshold of heat perception is near 0.7 mW/cm², with power densities of about 9.0 mW/cm² causing sensations of pain within one second of exposure. It is notable, that the non-liner effects apply; e.g. for 3 GHz {decimeter, not millimeter wave lengths}, the thresholds are on the order of 30 times less.
...
### Cross-case consistency — injury severity and patterns are highly consistent, with no significant differences between the three antenna engineers and the Cash-Landrum cases

> For example, in the cases this reviewer has studied, the directionality and the times of the known RF / EM exposures and the injury severity and patterns are highly consistent: There are no significant differences in either the reported acute effects (symptoms) or the physician-observed (signs) between the case of three antenna engineers and the Cash-Landrum cases.
...
### Stated purpose — the paper argues that data exists to reverse engineer propulsion systems of anomalous aerospace vehicles, independent of origin (the sentence continues "based on biology" across the p.17/p.18 boundary; quoted to the p.17 page edge)

> As the purpose of this paper is to argue that data exists to "reverse engineer" propulsion systems of anomalous aerospace vehicles, independent of origin, based on

| Field | Value |
|---|---|
| Attributed to | DIRD #26 (Anomalous Acute and Subacute Field Effects on Human Biological Tissues), 11 March 2010 |
| Source | [archived source](../sources/government/dird-26-field-effects-human-biological-tissues-2010.pdf) |
| Location | p. 17, ¶ Ch. Five |

---

### Schuessler catalog — Appendix A reproduces the Schuessler catalog of 356 selected cases of UFO-induced physiological effects 1873–1994 ("complied" is the document's form for compiled)
...
|---|---|---|
| (b)(6) | [author identity withheld under FOIA exemption (b)(6)] | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
| (b)(3):10 USC 424 | [DIA component withheld under (b)(3), 10 USC 424] | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
| non-liner | non-linear | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
| complied | compiled | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
| Specific Absorbed Rate | Specific Absorption Rate | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
| parasthesiae | paresthesiae | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
| AAWSA | Advanced Aerospace Weapon System Applications Program (AAWSAP) | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
...
|---|---|---|
| Field Effects on Biological Tissues | Anomalous Acute and Subacute Field Effects on Human Biological Tissues | government/dird-26-field-effects-human-biological-tissues-2010.pdf |
