...
| Field | Value |
|---|---|
| Speaker | David Grusch ([`/people/david-grusch`]) |
...
|---|---|---|---|
| 11‡ hours | 11½ hours | government/congress-gov-house-hearing-transcript-20230726.pdf | pdftotext appears to have rendered a fraction glyph (likely ½) as the double-dagger character (U+2021). Preserved verbatim in q31. The substantive claim is that Grusch spent approximately 11.5 hours with the House and Senate intel committees. |
| News Nation | NewsNation | government/congress-gov-house-hearing-transcript-20230726.pdf | Grusch refers to the outlet as "News Nation" (two words) in multiple exchanges; the cable channel's canonical brand is "NewsNation" (one word). Preserved verbatim where quoted (q38); the network's canonical form goes into the wrap_path and entity name. |
