...
both. Unlike archetype / kind / status, id has no downstream enum
validation — the null case has no third-line defense. Accepted gap:
the corpus is clean, contributor scaffolders (new.py,
research-scaffold.py) populate id automatically, and tightening here
without a real incident would be defensive coverage of a scenario
