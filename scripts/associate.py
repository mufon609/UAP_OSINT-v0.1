...
def generate_section(groups):
    """Generate the `## Associated Nodes` section. Post-OQ-removal
    (2026-04-21) Associated Nodes is always the final section of a
    node body, so no trailing `---` separator is emitted."""
