...
#      scripts/tests/test_reproduced_datasets.py — reproduced_datasets shape +
#                                              manifest/CSV-sibling presence (silent absent)
...
steps=(
    ...
    $'test_reproduced_datasets\tpython3 scripts/tests/test_reproduced_datasets.py'
