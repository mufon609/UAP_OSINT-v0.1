...
Per urigeller.com, Uri Geller is one of the world’s most investigated and celebrated mystifiers, famous around the globe for his mind-bending abilities. Uri Geller was born in Israel on December 20, 1946. His parents were of Hungarian and Austrian descent, and he is distantly related on his mother’s side to Sigmund Freud ([`/people/sigmund-freud`]). At the age of four he had a mysterious encounter with a sphere of light while in a garden near his house; a retired Israeli air force officer, who was an eyewitness to this encounter, validated this mystifying event decades later per the biography page. He first became aware of his unusual powers when he was about five, when during a meal his spoon curled up in his hand and broke although he had applied no physical pressure to it. His parents were somewhat shocked and Uri did not mention the incident to anyone else at that time. He developed these powers in school by demonstrating them to pupils.

When he was eleven, he went to live in Cyprus, where he remained until he was seventeen. He then returned to Israel, served as a paratrooper in the Israeli army and fought in the Six-Day War of 1967 during which he was wounded in action. From 1968 to 1969 Uri worked as a model, being photographed for many different ad campaigns. In 1969 he began to demonstrate his powers of telepathy and psychokinesis to small audiences. By the end of 1971, he was a household name throughout Israel, thanks to his numerous stage appearances. He was given a huge boost by the then Prime Minister, Golda Meir ([`/people/golda-meir`]) when asked on a national radio programme what she predicted for the future of Israel, she replied, "Don’t ask me – ask Uri Geller!"

Per the November 24, 2007 piece "Uri Geller – UFOs, metal-bending and the PSI war" by Brendan Burton ([`/people/brendan-burton`]) on urigeller.com, after getting wounded during the Six Day War, Uri left the Israeli Army, and worked as a fashion model by day, and at night started to give displays of his mind-power with the support of his brother-in-law, Shimson (Shipi) ([`/people/shimson-shtrang`]). His extraordinary demonstrations quickly became well known and he soon developed a professional stage show. Word had spread far enough to warrant the mysterious Andrija Puharich ([`/people/andrija-puharich`]) to enter the scene. Puharich had been working previously with the equally mysterious, Dr Vinod, drawing together "channelled" information on the principles of "The Nine" and was a pivotal figure in the "contactee" movement. Under the wing of Puharich, Uri was flown to the USA, where he was introduced to astronaut Edgar Mitchell ([`/people/edgar-mitchell`]), and physicists Hal Puthof ([`/people/hal-puthoff`]) and Russel Targ ([`/people/russell-targ`]). In December 1972 he allowed himself to become the subject of a scientific study undertaken at the prestigious Stanford Research Institute ([`/organizations/stanford-research-institute`]) at Menlo Park, California.

---

## UAP Relevance

Per urigeller.com, Uri Geller is the known subject of the Stanford Research Institute ([`/organizations/stanford-research-institute`]) parapsychology study: "The world’s most prestigious scientific magazine, Nature, published a paper on Uri’s work at the Stanford Research Institute in the U.S.A – a unique endorsement, and an irrefutable proof that his skills are genuine." The same biography states his work with the FBI ([`/organizations/fbi`]) and the CIA ([`/organizations/cia`]) has ranged from using Mind Power to erase KGB computer files and track serial killers, to attending nuclear disarmament negotiations to bombard and influence the Russian chief negotiator with positive thought waves so that the Soviet delegation would sign the Nuclear Arms Reduction Treaty. The biography further states that Uri also addressed a group of US Senators and National Security Executives at the high-security room in the Capitol Building in Washington; for decades this aspect of his career was too confidential and controversial to discuss. In 2017 the CIA released a large volume of previously top secret data, including documents and memos about the tests that were performed on Uri Geller, and per the biography the CIA concluded that Uri "demonstrated his paranormal perception ability in a convincing and unambiguous manner."

Per the November 24, 2007 Brendan Burton piece on urigeller.com, Russell Targ ([`/people/russell-targ`])’s comment on his experiences resulting from the SRI experiments: "Uri was at our laboratory at SRI for six weeks in 1973. He showed remarkable ESP perceptual ability to describe and draw hidden pictures. He was by no means the best person to visit our lab and carry out this type of remote viewing, but he was certainly better than the average bear in this capability. He did not bend any metal under acceptably controlled conditions, but I have since that time seen and done paranormal bending under excellent conditions." Per the same piece, the results of the experiments and studies, which presented an "existence of one or more perceptual modalities through which individuals obtain information about their environment" were written up in Nature magazine. Hal Puthoff ([`/people/hal-puthoff`]) said of the SRI experiments: "Our publications make our statement, and our personal feelings are congruent with what we’ve published. And in the intervening years of listening to the criticisms of the skeptics we have yet to be shown any viable reason to reassess our position."
...
| [`/organizations/save-a-childs-heart`] | Patron ("for which he has served as patron for many years" per biography ¶34) |  | news/urigeller-com-biography-20260516.html |  |
| [`/organizations/royal-hospital-for-children-bristol`] | Honorary Vice-President |  | news/urigeller-com-biography-20260516.html |  |
| [`/organizations/royal-berkshire-hospital`] | Honorary Vice-President |  | news/urigeller-com-biography-20260516.html |  |
| [`/organizations/uri-geller-museum`] | Proprietor (runs the Uri Geller Museum in Old Jaffa per biography ¶35) |  | news/urigeller-com-biography-20260516.html | Museum opening date not attested in the archived urigeller.com sources for this node; biography ¶35 attests only the current operating state ("Uri lives in Old Jaffa and runs the Uri Geller Museum"). Period_start intentionally left blank pending archival of a primary source attesting the opening date. External secondary sources (Wikipedia, urigellermuseum.com, JNS November 2021 coverage) place the museum opening in 2021 — see rumor r4. The prior anchoring of period_start to Geller's 2016 return-to-Israel was contributor speculation conflating two distinct events; that anchor was removed during the 2026-05-16 web-audit review. |
...
| Field | Value |
|---|---|
| Attributed to | Uri Geller's biography page on urigeller.com, ¶2, 1946-12-20 |
...
| Field | Value |
|---|---|
| Attributed to | Uri Geller's biography page on urigeller.com, ¶7, 1971 |
| Source | [archived source](../sources/news/urigeller-com-biography-20260516.html) |
| Location | ¶7 |
...
| Field | Value |
|---|---|
| Attributed to | Lead paragraph of Uri Geller's biography page on urigeller.com (his own publishing presence) |
| Source | [archived source](../sources/news/urigeller-com-biography-20260516.html) |
| Location | ¶1 |
...
| Field | Value |
|---|---|
| Attributed to | Uri Geller's biography page on urigeller.com, ¶32 — biography page's quotation of the declassified CIA verdict |
| Source | [archived source](../sources/news/urigeller-com-biography-20260516.html) |
| Location | ¶32 |
...
|---|---|---|---|---|
| 1946-12-20 | Born in Israel; parents of Hungarian and Austrian descent; distantly related on his mother's side to Sigmund Freud ([`/people/sigmund-freud`]) | other | news/urigeller-com-biography-20260516.html |  |
| 1950 | At age four (c. 1950), mysterious encounter with a sphere of light in a garden near his house; a retired Israeli air force officer eyewitness validated this event decades later per biography | incident | news/urigeller-com-biography-20260516.html |  |
| 1951 | At about age five (c. 1951), during a meal, his spoon curled up in his hand and broke without physical pressure — first awareness of his unusual powers per biography | incident | news/urigeller-com-biography-20260516.html |  |
| 1957 | Moved to live in Cyprus (c. 1957, age 11) where he remained until age 17 | other | news/urigeller-com-biography-20260516.html |  |
| 1967 | Served as a paratrooper in the Israeli army and fought in the Six-Day War of 1967, during which he was wounded in action | affiliation | news/urigeller-com-biography-20260516.html |  |
| 1968 | Worked as a model, photographed for many different ad campaigns (1968–1969); per Brendan Burton, also began night displays of his mind-power with the support of his brother-in-law, Shimson (Shipi) ([`/people/shimson-shtrang`]) | affiliation | news/urigeller-com-biography-20260516.html |  |
...
| 2007-11-24 | Brendan Burton ([`/people/brendan-burton`]) article "Uri Geller – UFOs, metal-bending and the PSI war" published; republished on urigeller.com under the Scientific & Paranormal section. Contains verbatim Russell Targ ([`/people/russell-targ`]) and Hal Puthoff ([`/people/hal-puthoff`]) quotes about the SRI experiments | publication | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html |  |
...
|---|---|---|
| [`/people/sigmund-freud`] | Distantly related on his mother's side per Geller's biography; "His mother thought he inherited [his unusual powers] from Sigmund Freud" per biography ¶3 | Lineage verbatim in q2 (¶2) and q3 (¶3); biography ¶13 additionally states "He counts Sigmund Freud among his forebears." Residue: the lineage is attested only on Geller's own biography page — no external genealogical record corroborating it is archived in this repository — yet it has been repeated downstream as fact in tertiary sources (Wikipedia's Geller entry, biographer profiles, popular accounts). See credibility_notes Freud-flag paragraph and the per-quote attestation-class Pending Convention Question in meta/topic/research-queue.md (the schema-level fix would let q2 and q3 render "Attestation class: self-attestation on subject's own publication" automatically; until then, the flag lives in credibility_notes). |
| [`/people/shimson-shtrang`] | Brother-in-law (referred to as Shimson, Shipi); per Brendan Burton, supported Uri's mind-power displays from his post-Israeli-Army modeling era |  |
| [`/people/andrija-puharich`] | Introducer / sponsor — under whose wing Uri was flown to the USA and introduced to Edgar Mitchell, Hal Puthof, and Russel Targ per Brendan Burton ¶5 | Per Brendan Burton, Puharich had been working previously with Dr Vinod, drawing together 'channelled' information on the principles of 'The Nine' and was a pivotal figure in the 'contactee' movement. |
| [`/people/hal-puthoff`] | SRI co-investigator per Brendan Burton ¶5 ("Under the wing of Puharich, Uri was flown to the USA, where he was introduced to astronaut Edgar Mitchell, and physicists Hal Puthof and Russel Targ"); Puthoff verbatim quote on the SRI experiments at ¶12 | Source-form "Puthof" preserved as-source per naming_quirks nq1. Hal Puthoff is built at /people/hal-puthoff and does not currently carry a Geller cross-reference; building this Geller node creates the bidirectional anchor. |
| [`/people/russell-targ`] | SRI co-investigator and primary-witness attestor of Uri's SRI tenure per Brendan Burton ¶7 (Targ verbatim quote — six weeks at SRI laboratory in 1973, remarkable ESP perceptual ability, no metal bending under acceptably controlled conditions) | Source-form "Russel" preserved as-source per naming_quirks nq2. Russell Targ is built at /people/russell-targ and does not currently carry a Geller cross-reference; building this Geller node creates the bidirectional anchor. Full Targ verbatim quote captured in credibility_notes and top_relevance. |
| [`/people/edgar-mitchell`] | Astronaut, met when Uri was flown to the USA under the wing of Andrija Puharich per Brendan Burton ¶5; Mitchell is named in Burton's sources list (¶ Sources) as a correspondence source for the article |  |
| [`/people/golda-meir`] | Prime Minister of Israel who endorsed Uri on national radio in 1971 — "Don't ask me – ask Uri Geller!" — per biography ¶7 |  |
| [`/people/jane-katra`] | Russell Targ's co-author and spiritual healer named in Targ's PK-party anecdote per Brendan Burton ¶9 — "My co-author Jane Katra, a spiritual healer with small delicate hands, rolled up the bowl of a teaspoon at a PK party with Jack Hauk last year" |  |
| [`/people/jack-hauk`] | Metallurgist from Boeing; PK-party host described by Russell Targ ([`/people/russell-targ`]) in Brendan Burton ¶9–¶10 |  |
| [`/people/jack-sarfatti`] | Theoretical physicist; quoted by Brendan Burton ¶15-¶17 on PK signal-nonlocality physics and a 1985 Brasil anecdote (General in the Brasilian Army; alleged UFO landed in the Amazon jungle); named in Burton's Sources list | Sarfatti's full verbatim quote on PK / signal-nonlocality + the Brasil 1985 / Amazon-UFO anecdote is in the Burton source extract; not registered as a Statements quote on this Geller artifact because Sarfatti's statements are about himself / about PK physics rather than directly about Uri. |
| [`/people/eldon-byrd`] | Metallurgist and US Naval scientist (deceased late 2002); met with Uri at George Washington University demo and studied NITINOL altered by Geller at the US Navy Government Lab per Brendan Burton ¶19-¶22 | Byrd's verbatim observations of Geller (telepathy, mending broken watches and clocks, sprouting seeds; NITINOL alteration with electron micrograph / density / photographic / microscopic analytical tests) are in the Burton source extract; not registered as a separate Statements quote on this Geller artifact because the speaker is Byrd, not Geller. Byrd's own person artifact (when built) would carry the verbatim observations. |
| [`/people/wernher-von-braun`] | Named by Brendan Burton ¶16 ("Dr Werner von Braun") in the highly-credible witness-testimony list to the Geller bending phenomena |  |
| [`/people/susan-blackmore`] | Skeptic quoted by Brendan Burton ¶26 on extra-sensory perception, ghosts, UFOs, crystal powers, and astrology |  |
| [`/people/brendan-burton`] | Author of the November 24, 2007 article "Uri Geller – UFOs, metal-bending and the PSI war" republished on urigeller.com; corresponded with Sarfatti, Puthoff, Blackmore, Mitchell, Targ, and Byrd per the article's Sources list |  |
| [`/people/george-knapp`] | Coast to Coast AM radio interviewer (October 2013); the four-hour interview generated traffic that almost crashed the website's host servers per biography ¶27 |  |
| [`/people/jonathan-margolis`] | Journalist and master biographer; author of "The Secret Life of Uri Geller: CIA Masterspy?" (2013) per biography ¶26 |  |
| [`/people/vikram-jayanti`] | Oscar-winning director of the July 2013 BBC 1.5-hour documentary "The Secret Life of Uri Geller – Psychic Spy?" per biography ¶25 |  |
...
| FBI / CIA post-SRI collaboration (self-attested per biography) | Per biography ¶9, work that has ranged from using Mind Power to erase KGB computer files and track serial killers, to attending nuclear disarmament negotiations to bombard and influence the Russian chief negotiator with positive thought waves so that the Soviet delegation would sign the Nuclear Arms Reduction Treaty |  | self-attested | low | news/urigeller-com-biography-20260516.html | Verbatim in q5 (¶9). Residue: self-attestation only — no primary-source corroboration archived. The biography itself states "For decades this aspect of his career was too confidential and controversial to discuss" (¶10). |
| US Senate / National Security Executives Capitol Building briefing | Briefer — addressed a group of US Senators and National Security Executives at the high-security room in the Capitol Building in Washington per biography ¶10 |  | self-attested | low | news/urigeller-com-biography-20260516.html | Verbatim in q6 (¶10). Residue, self-attestation only. The about-uri page's "Mind Over Missile?" teaser (¶ teaser block) attests this thread via the 4 May 1987 US News & World Report "Washington Whispers" item that named Senator Claiborne Pell ([`/people/claiborne-pell`]) as the convener; the underlying USNWR primary source is not archived in this repository. |
...
Per biography ¶17, Uri provided a drawing for Michael Jackson ([`/people/michael-jackson`])’s album Invincible, and Uri’s drawings are featured on Michael Jackson’s latest albums; the latest claim in the biography page is from years before Michael Jackson’s death in 2009, when Invincible became Michael Jackson’s last released album.
...
**Investigator note:** The claim is attested by Geller's own biography as a self-account (registered as q2). The retired Israeli air force officer who allegedly validated the event is not named, no validation document is cited, and no primary record of the officer's attestation is archived in this repository. The age-four encounter itself is captured in q2 as Geller's self-attestation; the third-party-validation portion is the unattested element here.
...
|---|---|---|---|
| Hal Puthof | Hal Puthoff | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Brendan Burton typo (single 'f' instead of double); canonical Puthoff is attested across the same article in Burton's intro at ¶11 ("Hal Puthoff says of the SRI experiments") and in the Sources list at the end. One-instance typo, not alias-of-record. |
| Russel Targ | Russell Targ | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Brendan Burton typo (single 'l' instead of double). The Burton article uses 'Russel' twice in narrator prose (¶5 introducing the SRI visit; ¶6 introducing the Targ-quote interview); the Sources list at the end of the article uses canonical 'Russell Targ'. Recurring two-instance typo within narrator prose; Sources-list canonical-form attestation rules typo (not alias-of-record). |
| psychokenesis | psychokinesis | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Brendan Burton typo. Original sentence: "The ability to ‘bend’ metals by ‘mindpower’ is known as ‘psychokenesis’ ( PK)." Canonical "psychokinesis" is attested elsewhere in the same article and across the biography page. |
| pheomena | phenomena | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Brendan Burton typo dropped the "n". Original sentence: "Sarfatti has some intriguing insight as a witness to the ‘bending’ pheomena." |
| Brasil | Brazil | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | UK-spelling variant of "Brazil" preserved as-source in Jack Sarfatti's verbatim quote per the source-priority hierarchy (witness's own words). Original: "I have seen things ( PK) in my trip to Brasil in 1985 shown to me by a General in the Brasilian Army". |
| Brasilian | Brazilian | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | UK-spelling adjective form of "Brazilian" preserved as-source. Pairs with nq5. |
| statisical | statistical | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Eldon Byrd verbatim quote as transcribed by Brendan Burton. Original: "rather than the soft statisical pablum (baby food) of parapsychology". One-character omission ("t" dropped); preserved as-source. |
| form our forebears | from our forebears | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Burton transcription of Geller's book Mind Medicine (1999) — likely transcription typo ("form" for "from"). Preserved as-source in q8 quote text. |
| out lives | our lives | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Burton transcription of Geller's book Mind Medicine (1999) — likely transcription typo ("out" for "our"). Preserved as-source in q8 quote text. |
| Werner von Braun | Wernher von Braun | news/urigeller-com-scientific-paranormal-ufos-metal-bending-psi-war-20260516.html | Brendan Burton typo (missing "h"). The canonical form Wernher Magnus Maximilian Freiherr von Braun is used by Wikipedia and by Geller's own site elsewhere — the standalone urigeller.com piece "Dr Wernher von Braun & Life After Death" (linked from the scientific-paranormal index, not in the archived source set for this node) uses the canonical spelling. The Burton article is the only one-off "Werner" in the archived corpus for this node; Geller-site house style is "Wernher". Source-form preserved in the Burton-attested quote; canonical slug `/people/wernher-von-braun` used for the cross-reference wrap per Category 3 of the source-form-preservation discipline. |
| Israel | British Mandate of Palestine | news/urigeller-com-biography-20260516.html | Geographic-anachronism source-form variant. Geller's biography page attests his birthplace as "Israel" on December 20, 1946. The State of Israel was declared on May 14, 1948 — 17 months after Geller's birth — and what is now Tel Aviv was, at the time of his birth, part of the British Mandate of Palestine (1920-1948). Modern usage of "Israel" can refer to either the State of Israel (post-1948) or the Land of Israel (the territory, ahistorical); the biography uses it in the second sense. Wikipedia, Haaretz, and IMDb biographical entries on Geller all qualify the birthplace as Tel Aviv-within-Palestine; only Geller's own biography page elides the distinction. Source-form preserved as-source in quotes q2 and timeline t1 per the source-priority hierarchy (subject's own framing for a fact about himself). The resolution preserve-as-sic-in-quotes is the closest existing fit in the naming_quirks enum but does not perfectly capture the geographic-vs-temporal anachronism shape — see meta/topic/research-queue.md Pending Convention Questions for the broader naming_quirks resolution-enum extension question (potential `geographic-anachronism` resolution category). |
