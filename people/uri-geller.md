...
| [`/organizations/uri-geller-museum`] | Proprietor (runs the Uri Geller Museum in Old Jaffa per biography ¶35) |  | news/urigeller-com-biography-20260516.html | Opening date not attested in the archived sources (biography ¶35 attests only the current operating state); period_start left blank pending a primary source. Secondary-source 2021 opening date carried at rumor r4. |
...
|---|---|---|
| [`/people/sigmund-freud`] | Distantly related on his mother's side per Geller's biography; "His mother thought he inherited [his unusual powers] from Sigmund Freud" per biography ¶3 | The lineage is attested only on Geller's own biography page — no external genealogical record corroborating it is archived in this repository — yet it has been repeated downstream as fact in tertiary sources. See the credibility_notes Freud-flag paragraph. |
...
| [`/people/andrija-puharich`] | Introducer / sponsor — under whose wing Uri was flown to the USA and introduced to Edgar Mitchell, Hal Puthof, and Russel Targ per Brendan Burton ¶5 |  |
| [`/people/hal-puthoff`] | SRI co-investigator per Brendan Burton ¶5 ("Under the wing of Puharich, Uri was flown to the USA, where he was introduced to astronaut Edgar Mitchell, and physicists Hal Puthof and Russel Targ"); Puthoff verbatim quote on the SRI experiments at ¶12 | The Burton article spells the name "Puthof" (single f); the canonical Puthoff is recorded in the Source-Form Notes. |
| [`/people/russell-targ`] | SRI co-investigator and primary-witness attestor of Uri's SRI tenure per Brendan Burton ¶7 (Targ verbatim quote — six weeks at SRI laboratory in 1973, remarkable ESP perceptual ability, no metal bending under acceptably controlled conditions) | The Burton article's narrator prose spells the name "Russel" (single l); the canonical Russell Targ is recorded in the Source-Form Notes. |
...
| [`/people/michael-jackson`] | Friend; per biography ¶17 Uri provided a drawing for Michael Jackson's album "invincible" and Uri's drawings are featured on Michael Jackson's latest album | Source-rot: the biography page ¶17 wording "Michael Jackson's latest albums" predates Michael Jackson's death in 2009 — Invincible (2001) was his then-most-recent album and became his last. The "latest" wording should not be read as a current-tense claim. See the credibility_notes MJ-rot-flag paragraph. |
...
|---|---|---|---|---|---|---|
| CIA-sponsored Stanford Research Institute parapsychology investigation | Test subject | 1972-12 – 1973-08 | primary-source | high | government/cia-rdp79-00999a000300030027-0-uri-geller-sri-aug1973.pdf | Subject status rests on three archived CIA primary sources naming Geller directly — the Aug 1973 SRI report (timeline t23), the contract 1471(S)73 progress report (timeline t22), and the Nature paper (timeline t24, relationship r21) — which is what carries the primary-source basis and high confidence in the columns above. |
...
| US Senate / National Security Executives Capitol Building briefing | Briefer — addressed a group of US Senators and National Security Executives at the high-security room in the Capitol Building in Washington per biography ¶10 |  | self-attested | low | news/urigeller-com-biography-20260516.html | Self-attestation only. The 1987 US News & World Report "Washington Whispers" item that anchors this thread (timeline t12, quote q7) is itself unarchived — known only through Geller's about-uri teaser. |
