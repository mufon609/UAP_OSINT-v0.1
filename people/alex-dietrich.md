...
| [`/people/chad-underwood`] | testimonial | On the subsequent F/A-18F sortie that captured the FLIR1 targeting-pod video; visually observed the same Tic Tac object. Position on the aircraft has two conflicting attestations between Dietrich and Underwood; see Credibility Notes for the source-priority resolution. | transcripts/somewhere-in-the-skies-dietrich-2024-downloaded.md |
