...
|---|---|---|---|---|
| [`/organizations/dia`] | AAWSA Program Manager (Defense Warning Office, Directorate for Analysis) | – 2016 | government/dia-advancedspacepropulsion-puthoff-dird-20100329.pdf | Puthoff's 29 March 2010 DIRD names "James T. Lacatski, D.Eng., AAWSA Program Manager, Defense Intelligence Agency, ATTN: CLAR/DWO-3, Bldg 6000, Washington, DC 20340-5100" on page 1 as the contact for the AAWSA Program. Period end attested by Lacatski self-attestation in WEAPONIZED EP 38 ("I retired in 2016"). Period start not attested in the archived sources; Lacatski self-attests in WEAPONIZED EP 38 that he came "from the contractor world in the and the first half of my career" prior to DIA — DIA tenure start date is therefore unattested at the artifact level. |

---

## Statements

### AAWSAP Creation, Funding, and Lifecycle
...
| Field | Value |
|---|---|
| Attributed to | Lacatski in 2021 Mystery Wire book-launch interview with George Knapp and Colm Kelleher, responding to Knapp's question about DoD spokesperson statements, 2021-10-12 |
| Source | [archived source](../sources/transcripts/mysterywire-lacatski-kelleher-knapp-2021-downloaded.md) |
| Location | [0:39]–[1:23] |

**Also attested:**

- Lacatski in WEAPONIZED EP 38 describing how AAWSAP's contract was structured at DIA; 2023-10-16; [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md); [3:19]–[3:52]

> [1:51] well the advanced Aerospace weapon system applications program was uh uh basically created between myself and Senator Reed at the defense intelligence agency uh it was a $22 million program uh it had the capability of going five years we completed our objectives in two years

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 with George Knapp and Jeremy Corbell, responding to Corbell's opening request to outline the AAWSAP / AATIP difference, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [1:51]–[2:21] |

> [51:59] well I can tell you George that as you know um those events in 2011 occurred after the the oap program was shut down so o assap was officially sort of stopped in terms of funding being received um in September of 2010 uh by December member of 2010 we had a 90-day no cost extension and at that stage the program was over

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 responding to George Knapp's question about AAWSAP-team contact with "keepers of the secrets", 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [51:59]–[52:32] |

### AATIP Name and AAWSAP Distinction
...
| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 explaining his lack of direct involvement with AATIP and his retirement date, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [7:38]–[8:18] |
...
### AAWSAP Compartmentation and Security

> [17:30] so by our enemies and our enemies you can be sure they're listening to this show right now you can be sure that they were monitoring Assam you can be sure that perhaps they had employees hopefully not in Gia but in the contractor part that was we're giving out information for I am I am I know that so the thing is is we can't say anything more than what we've been approved to say

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 explaining why he cannot answer further questions about the craft beyond the book wording, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [17:30]–[18:09] |

> [49:22] and only interview it was a close osed program it operated very similar to a sap the director the director of analysis and my office Chief and of course division Chief knew about this program no one else did now I was also protected by the stove pipe nature of that I did not have to D address political type questions I I I was insulated but but they were too they there was no one else people in the surrounding cubicles didn't know

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 emphasizing the closed-program structure of AAWSAP within DIA, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [49:22]–[50:04] |

**Also attested:**

- Lacatski in 2021 Mystery Wire book-launch interview explaining the AAWSAP / AATIP press mix-up as a consequence of compartmentation; 2021-10-12; [archived source](../sources/transcripts/mysterywire-lacatski-kelleher-knapp-2021-downloaded.md); [3:20]–[3:55]

### 2011 Capitol Craft-of-Unknown-Origin Statement

> [15:55] you're telling us you told us because you were allowed to tell us that our government has a UFO in its possession and has been able to access the inside of it right yes you I was allowed to tell you

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 confirming the 2011 Capitol meeting passage from chapter 9 of "Inside the US Government Covert UFO Program", 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [15:55]–[16:11] |

> [33:54] you see it yourself can't answer that okay but if the answer was no you could answer that right uh no that that comes goes back to something that occurred uh a similar question very similar to your question it wasn't asked by you but it was asked to Callum and he said we found no smoking gun that is the standard answer we're to give is so I could say no and it still not be the truth so the thing is is security is Paramount we follow the rules

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 declining to answer Corbell on whether he personally saw the craft, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [33:54]–[34:30] |

### AAWSAP Research Products and Corpus

> [21:26] uh we solicited the input for the topics for the 38 papers from uh from Air Force intelligence CIA uh Naval intelligence and uh uh Ground Intelligence that those are the topics they chose to do but they were completely legitimate at the time and by the way they're pretty close to state-of-the-art right now

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 explaining the inter-agency origin of the DIRD topic list, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [21:23]–[21:54] |
...
| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 responding to George Knapp's question about David Grusch, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
...
| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 responding to Corbell pressing on UAP transparency and disclosure advocacy, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [1:21:01]–[1:21:11] |

> [1:22:34] okay so you are trying to convey that to the American proper way I'm not I'm not going out there and and and uh and interviewing with uh everybody uh to say what I really feel uh no it was hard to get you to do this I mean I can testify you're

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 responding to Corbell on disclosure advocacy, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
| Location | [1:22:37]–[1:22:56] |

> [1:46:30] you see I'm not speaking at all I'm not going beyond what it was what you read from the book

| Field | Value |
|---|---|
| Attributed to | Lacatski in WEAPONIZED EP 38 responding to Corbell's closing recap of the 2011 Capitol craft-of-unknown-origin passage, 2023-10-16 |
| Source | [archived source](../sources/transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md) |
...
### Pre-AAWSAP Legacy Program Question
...
### Paranormal Scope and Phenomena
...
### DIA Background and AAWSAP Origins
...
### Recovered Materials, Transfers, and Facilities
...
|---|---|---|---|---|
| 2008-09 | AAWSAP funded — Lacatski's self-attested start of the program he co-created with Senator Reed at DIA | program | transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md |  |
| 2010-03-29 | Puthoff's AAWSAP DIRD on Advanced Space Propulsion Based on Vacuum (Spacetime Metric) Engineering — Lacatski named "AAWSA Program Manager" on the Administrative Note (page 1) | publication | government/dia-advancedspacepropulsion-puthoff-dird-20100329.pdf | [`/documents/dird-15-advanced-space-propulsion`] |
| 2010-09 | AAWSAP funding ended — Lacatski says in WEAPONIZED EP 38 "o assap was officially sort of stopped in terms of funding being received in September of 2010" | program | transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md |  |
| 2010-12 | AAWSAP 90-day no-cost extension ended — per Lacatski in WEAPONIZED EP 38, "by December member of 2010 we had a 90-day no cost extension and at that stage the program was over" | program | transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md |  |
| 2011 | 2011 Capitol building meeting — Lacatski posed a question to a US senator and an agency under secretary that the United States was in possession of a craft of unknown origin and had successfully gained access to its interior (per chapter 9 of the 2023 book; Lacatski affirms in WEAPONIZED EP 38) | incident | transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md |  |
| 2016 | Lacatski's retirement from DIA — self-attested in WEAPONIZED EP 38 ("I retired in 2016") | role | transcripts/weaponized-038-lacatski-kelleher-2023-downloaded.md |  |
| 2021-10 | "Skinwalkers at the Pentagon" published — Lacatski / Kelleher / Knapp; passed a 14-month DoD pre-publication review per Lacatski in the 2021 Mystery Wire interview | publication | transcripts/mysterywire-lacatski-kelleher-knapp-2021-downloaded.md | [`/documents/skinwalkers-at-the-pentagon-2021`] |
...
| 2024 | "Inside the US Government Covert UFO Program: New Insights" — third Lacatski / Kelleher / Knapp book (PART 1 lists it among "those books are Skinwalkers at the Pentagon, Inside the US Government Covert UFO Program, Initial Revelations, the new book New Insights") | publication | transcripts/weaponized-096-lacatski-part1-2025-downloaded.md |  |
...
| 2025-11-05 | WEAPONIZED PART 1 broadcast — Lacatski self-attests as creator and DIA program manager of the follow-on Kona Blue program, KBP; AARO disinformation framing; recovered craft hull breach restated | testimony | transcripts/weaponized-096-lacatski-part1-2025-downloaded.md | [`/transcripts/weaponized-096-lacatski-part1-2025`] |
| 2025-11-11 | WEAPONIZED PART 2 broadcast — Lacatski says Tic Tac is not US technology, describes own MIB sighting during Kona Blue, says Kona Blue is "much more than going and getting what some have described as 60 year old parts" | testimony | transcripts/weaponized-097-lacatski-part2-2025-downloaded.md | [`/transcripts/weaponized-097-lacatski-part2-2025`] |
...
|---|---|---|---|---|---|---|
| AAWSAP — Advanced Aerospace Weapon System Applications Program ([`/organizations/aawsap`]) | Program Manager / Director (Defense Warning Office, DIA) | 2008-09 – 2016 | primary-source | high | government/dia-advancedspacepropulsion-puthoff-dird-20100329.pdf | Three-source convergence: (1) Puthoff's FY 2009 vacuum metric engineering DIRD ([`/documents/dird-15-advanced-space-propulsion`]) names Lacatski as "AAWSA Program Manager" on page 1; (2) Elizondo's December 2024 sworn QFR Q1 response ([`/documents/elizondo-qfr-burlison-20241219`]) names Lacatski as "the former Director of the Advanced Aerospace Weapon System Application Program (AAWSAP)"; (3) Lacatski self-attests in WEAPONIZED EP 38 that AAWSAP was "basically created between myself and Senator Reed at the defense intelligence agency." Period_start: AAWSAP funding began September 2008 per Lacatski's WEAPONIZED EP 38 attestation. Period_end: 2016 retirement per Lacatski's WEAPONIZED EP 38 self-attestation. The program's funding ended September 2010 with a 90-day no-cost extension through December 2010, but Lacatski continued at DIA on related matters per his account through 2016. |
| SD004 Page-1 DOPSR-Cleared Statement (entered into 2024-11-13 House Oversight UAP hearing record) | Author of the September 6, 2023 DOPSR-cleared statement naming Lockheed Martin Space Systems Vice President Dr. James Ryder | 2023-09-06 | sworn-testimony | high | government/douglas-johnson-elizondo-qfr-burlison-20241219.pdf | Elizondo's sworn QFR Q1 response attests authorship; the SD004 page-1 substantive content (verbatim re-attested in Elizondo's QFR Q1 as Attachment 2) carries the Lockheed Martin / James Ryder UAP material divestment claim. DOPSR clearance attests authorization to publish; the underlying factual claim is not adjudicated by DOPSR. |
| Kona Blue Program (KBP) ([`/organizations/kona-blue`]) | Creator and DIA program manager (the follow-on program to AAWSAP) |  | on-record | medium | transcripts/weaponized-096-lacatski-part1-2025-downloaded.md | Lacatski's direct self-attestation in WEAPONIZED PART 1 ([`/transcripts/weaponized-096-lacatski-part1-2025`]): "I was the creator and DIA program manager of AASAP, the Advanced Aerospace Weapons System Applications Program, and of the follow-on Kona Blue program, KBP. Both classified programs, regardless of what the internet has said in the past. Both classified." PART 2 ([`/transcripts/weaponized-097-lacatski-part2-2025`]) refinement: Kona Blue was "a compartment reputed to be for recovered technology" AND "Kona Blue the program" first described in Skinwalkers at the Pentagon via the private-money structure. Lacatski says Kona Blue "is much more than going and getting what some have described as 60 year old parts" and that he knows "what the exchange parameters were and what was promised on all sides." Confidence: medium — Kona Blue is self-attested by Lacatski but lacks the multi-source convergence of the AAWSAP attribution (no equivalent of the Puthoff DIRD page-1 mention or the Elizondo QFR for Kona Blue specifically). Period dates not attested in source.  |

---

## Credibility Notes

Lacatski is named in the Puthoff vacuum metric engineering report ([`/documents/dird-15-advanced-space-propulsion`]) as "AAWSA Program Manager" at DIA ([`/organizations/dia`]). Elizondo's ([`/people/luis-elizondo`]) Question for the Record response ([`/documents/elizondo-qfr-burlison-20241219`]) names him as "the former Director of the Advanced Aerospace Weapon System Application Program (AAWSAP)." Lacatski said in WEAPONIZED Episode 38 that the program was "basically created between myself and Senator Reed at the defense intelligence agency."

Lacatski has not appeared before Congress under oath in the record here. His public statements are the books with kellerer and knap and the WEAPONIZED interview. The September 6, 2023 DOPSR document covered the open publication of a statement by Lacatski; that statement was not made under oath.

Lacatski said in WEAPONIZED Episode 38 he is "not going out there ... interviewing with everybody to say what I really feel" and he is "not going to say anything more than what's been approved." He said "am I a disclosure Advocate the answer is no" and that the difference between him and disclosure Advocate is security.

Lacatski wrote two books with kellerer ([`/people/colm-kelleher`]) and knap ([`/people/george-knapp`]) — "Skinwalkers at the Pentagon" and "Inside the US Government Covert UFO Program." Lacatski said in the Mystery interview that it took 14 months to get the stamp of approval from the DoD for public release of the book.
...
In the Mystery interview ([`/organizations/klas-tv`]) in Las Vegas Lacatski said the program ([`/organizations/aatip`]) at the Pentagon ([`/organizations/dod`]) is "quite distinct" from his program at DIA. He named Bob Bigelow's bass ([`/organizations/baass`]) at Bigelow Aerospace ([`/organizations/bigelow-aerospace`]) as the program contractor. Lacatski as author of the page 1 statement named Lockheed Martin ([`/organizations/lockheed-martin`]) Space Systems Vice President Dr. James Ryder ([`/people/james-ryder`]).
